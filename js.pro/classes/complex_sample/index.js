...
let cNum1 = new Complex(2, 3);
let cNum2 = new Complex(cNum1.imaginary, cNum1.real);

console.log(cNum1.plus(cNum2).toString());
console.log(cNum1.magnitude);
console.log(Complex.product(cNum1, cNum2).toString());
console.log(Complex.sum(cNum1, cNum2).toString());
